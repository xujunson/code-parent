package com.atu.extensible.aspect;

import com.atu.extensible.annotation.DataSourceType;
import com.atu.extensible.common.DataSourceContextHolder;
...
public class DataSourceAspect {
    /**
      ...
      */
    @Pointcut("execution(* com.atu.extensible.mapper..*(..))")
