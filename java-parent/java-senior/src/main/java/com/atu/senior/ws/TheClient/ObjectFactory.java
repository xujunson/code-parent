...
public class ObjectFactory {
    ...
    private final static QName _GetValue_QNAME = new QName("http://TheService.ws.senior.atu.com/", "getValue");
    private final static QName _GetValueResponse_QNAME = new QName("http://TheService.ws.senior.atu.com/", "getValueResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://TheService.ws.senior.atu.com/", name = "getValue")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://TheService.ws.senior.atu.com/", name = "getValueResponse")
