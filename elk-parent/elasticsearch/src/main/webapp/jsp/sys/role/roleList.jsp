...
<script type="text/javascript">
    ...
    function searchRoleFun(){
    	roleDataGrid.datagrid('load', $.serializeObject($('#searchRoleForm')));
    }
    ...
    function roleSXFun(){
    	if($('#searchRoleForm').css('display')=='none'){
    		$('#searchRoleForm').css('display','block');
    	}else{
    		$('#searchRoleForm').css('display','none');
    	}
    }
</script>
...
<div id="roleToolbar" style="display: none;">
 <form id="searchRoleForm" style="width:100%;height:30px;display:none">
            <table>
                <tr>
                    <td>角色名称:</td>
                    <td><input name="name" placeholder="" class="easyui-text" style="width:200px"/>
                          <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'fi-magnifying-glass',plain:true" onclick="searchRoleFun();">查询</a>
                        <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'fi-x-circle',plain:true" onclick="cleanRoleFun();">清空</a>
                    </td>
                </tr>
            </table>
        </form>
        <a onclick="addRoleFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'fi-plus icon-green'">添加</a>
         <a onclick="roleSXFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'fi-filter icon-green'">筛选</a>
</div>