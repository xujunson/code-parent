...
<script type="text/javascript">
    $(function() {
        <%--$('#resourceEditPid').combotree({--%>
            ...
            <%--panelHeight : 'auto',--%>
            <%--value : '${resource.pid}',--%>
            <%--onLoadSuccess:function(){//折叠--%>
            	<%--$('#resourceEditPid').combotree('tree').tree('collapseAll');--%>
            <%--}--%>
        <%--});--%>
        ...
        <table  class="grid">
            <tr>
                ...
                <td>
                    ...
                    <input name="name" type="text" placeholder="请输入资源名称" value="${resource.name}" class="easyui-text easyui-validatebox span2" data-options="required:true" >
                </td>
                <td>资源类型</td>
                <td>
            ...
            <tr>
                <td>资源路径</td>
                <td><input name="url" type="text" value="${resource.url}" placeholder="请输入资源路径" class="easyui-text easyui-validatebox span2" ></td>
                <td>打开方式</td>
                <td>
                    <select id="resourceEditOpenMode" name="openMode" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
                        ...
                        <option value="newWin">新窗口打开</option>
                    </select>
                </td>
            </tr>
            <tr>
                <td>菜单图标</td>
                <td><input name="icon" value="${resource.icon}" class="easyui-text"/></td>
                <td>排序</td>
            ...
            <tr>
                ...
                <td colspan="3">
                    <input type="hidden" name="pid" id="resEdit_Id" value="${resource.pid}">
                    <input type="text" class="easyui-text" readonly="readonly" id="resEdit_Id_disp" value="${resource.pName}">
                    <a href="javascript:void(0)" onclick="selectResource(false,'resEdit_Id','resEdit_Id_disp')" class="easyui-linkbutton">选择</a>
                </td>
            </tr>
        </table>
    </form>
