    ...
    $(function() {
        <%--$('#resourceAddPid').combotree({--%>
            ...
            <%--onLoadSuccess:function(){--%>
            	 <%--$('#resourceAddPid').combotree('tree').tree('collapseAll');--%>
            <%--}--%>
        <%--});--%>
...
<div style="padding: 3px;">
    <form id="resourceAddForm" method="post">
        <table class="grid">
            <tr>
                <td>资源名称</td>
                <td><input name="name" type="text" placeholder="请输入资源名称" class="easyui-text easyui-validatebox span2" data-options="required:true" ></td>
                <td>资源类型</td>
                <td>
            ...
            <tr>
                <td>资源路径</td>
                <td><input name="url" type="text" placeholder="请输入资源路径" class="easyui-text easyui-validatebox span2" data-options="width:140,height:29" ></td>
                <td>打开方式</td>
                <td>
            ...
            <tr>
                <td>菜单图标</td>
                <td ><input name="icon" class="easyui-text" value="fi-folder"/></td>
                <td>排序</td>
            ...
            <tr>
                <td>上级资源</td>
                <td colspan="3">
                    <input type="hidden" name="pid" id="resAdd_Id">
                    <input type="text" class="easyui-text" readonly="readonly" id="resAdd_Id_disp">
                    <a href="javascript:void(0)" onclick="selectResource(false,'resAdd_Id','resAdd_Id_disp')" class="easyui-linkbutton">选择</a>
                </td>
            </tr>
        </table>
    </form>
