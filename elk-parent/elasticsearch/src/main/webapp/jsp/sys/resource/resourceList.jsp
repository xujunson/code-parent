...
<script type="text/javascript">
    ...
    function searchResourceFun(){
    	resourceTreeGrid.treegrid('load', $.serializeObject($('#searchResourceForm')));
    }
    function cleanResourceFun(){
    	 $('#searchResourceForm input').val('');
    	 resourceTreeGrid.treegrid('load', {});
    }
    
    function resourceSXFun(){
    	if($('#searchResourceForm').css('display')=='none'){
    		$('#searchResourceForm').css('display','block');
    	}else{
    		$('#searchResourceForm').css('display','none');
    	}
    }
</script>
<div class="easyui-layout" data-options="fit:true,border:false">
	<!--  <div data-options="region:'north',border:false" style="display:none;overflow: hidden;background-color: #fff;height:30px" id="resourceSX">
...
<form id="searchResourceForm" style="width:100%;height:30px;display:none">
            <table>
                <tr>
                    <td>资源名称:</td>
                    <td><input name="name" placeholder="请输入资源名称" class="easyui-textbox" style="width:200px"/>
                          <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'fi-magnifying-glass',plain:true" onclick="searchResourceFun();">查询</a>
                        <a href="javascript:void(0);" class="easyui-linkbutton" data-options="iconCls:'fi-x-circle',plain:true" onclick="cleanResourceFun();">清空</a>
                    </td>
                </tr>
            </table>
        </form>
        ...
        <a onclick="resourceSXFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'fi-filter icon-green'">筛选</a>
</div>