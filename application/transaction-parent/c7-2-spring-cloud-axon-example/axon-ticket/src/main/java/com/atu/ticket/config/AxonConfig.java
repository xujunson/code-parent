...
public class AxonConfig {
    ...
    public Binding ticketQueueBinding() {
        return BindingBuilder.bind(ticketQueue()).to(exchange()).with("com.atu.ticket.event.#").noargs();
    }
    ...
    public Binding ticketSagaQueueBinding() {
        return BindingBuilder.bind(ticketSagaQueue()).to(exchange()).with("com.atu.ticket.event.saga.#").noargs();
    }
